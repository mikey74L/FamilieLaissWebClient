...
import {EntityManager, EntityAction, EntityType, Validator, ValidatorFunctionContext, AutoGeneratedKeyType} from 'breeze-client';
...
export class EntityManagerFactory {
    ...
    private async createMainManager(): Promise<EntityManager> {
        ...
        if (this.entityManagerFamilieLaiss == null) {
            ...
            //Setzen der Properties für die Facet-Groups
            var custType :any = this.entityManagerFamilieLaiss.metadataStore.getEntityType("FacetGroup");
            custType.setProperties({ autoGeneratedKeyType: AutoGeneratedKeyType.Identity });
            ...
            //Setzen der Properties für die Facet-Values
            ...
            //Setzen der Properties für die Media-Groups
            custType = this.entityManagerFamilieLaiss.metadataStore.getEntityType("MediaGroup");
            custType.setProperties({ autoGeneratedKeyType: AutoGeneratedKeyType.Identity });
            dp = custType.getProperty("Type");
            dp.displayName = this.loc.tr('Media_Group.Type.DisplayName', { ns: 'Metadata'});
            dp = custType.getProperty("NameGerman");
            dp.displayName = this.loc.tr('Media_Group.Name_German.DisplayName', { ns: 'Metadata'});
            dp = custType.getProperty("NameEnglish");
            dp.displayName = this.loc.tr('Media_Group.Name_English.DisplayName', { ns: 'Metadata'});
            dp = custType.getProperty("DescriptionGerman");
            dp.displayName = this.loc.tr('Media_Group.Description_German.DisplayName', { ns: 'Metadata'});
            dp = custType.getProperty("DescriptionEnglish");
            dp.displayName = this.loc.tr('Media_Group.Description_English.DisplayName', { ns: 'Metadata'});
            ...
            //Konfiguration für die MediaItemFacets
            custType = this.entityManagerFamilieLaiss.metadataStore.getEntityType("MediaItemFacet");
            custType.setProperties({ autoGeneratedKeyType: AutoGeneratedKeyType.Identity });
